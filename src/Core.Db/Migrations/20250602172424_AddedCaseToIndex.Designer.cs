...
namespace Core.Db.Migrations
{
    ...
    [Migration("20250602172424_AddedCaseToIndex")]
    partial class AddedCaseToIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Models.Action.ActionDefinition", b =>
                {
                    ...
                    b.Property<string[]>("DataSetUsedInAction")
                        .IsRequired()
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("Core.Models.Data.DataEntry", b =>
                {
                    ...
                    b.HasIndex("DataDefinitionId", "DataSetId", "CaseId")
                        .IsUnique();

                    b.ToTable("DataEntries");
                });

            modelBuilder.Entity("Core.Models.Data.DataSet", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Core.Models.Data.DataEntry", b =>
                {
                    ...
                    b.HasOne("Core.Models.Data.DataSet", "DataSet")
                        .WithMany("DataEntries")
